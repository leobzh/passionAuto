 ...
 */
final class Version20250220110624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE details_voitures DROP type');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE details_voitures ADD type VARCHAR(255) NOT NULL');
    }
}
